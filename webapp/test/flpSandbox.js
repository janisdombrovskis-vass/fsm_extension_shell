		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP FSM Extension",
									"targetURL": "#fsmextensionshell-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fsmextensionshell-display": {
								"semanticObject": "fsmextensionshell",
								"action": "display",
								"description": "SAP FSM Extension",
								"title": "SAP FSM Extension",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fsmextensionshell",
									"url": sap.ui.require.toUrl("fsmextensionshell")
								}
							}
						}
					}
